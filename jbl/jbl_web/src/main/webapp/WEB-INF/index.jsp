...
<body id="body" data-spy="scroll" data-target=".one-page-header" class="demo-lightbox-gallery lawyer-style">
	<main class="wrapper">
			...
			<div class="container">
				<div class="menu-container page-scroll">
					...
					<a class="navbar-brand" href="#body">
						<img src="./resources/assets/img/logo-dark.png" alt="Logo">
					</a>
				</div>
					...
					<div class="menu-container">
						<ul class="nav navbar-nav">
							<li class="page-scroll">
								<a href="#about"><span data-hover="About">소개합니다</span></a>
							</li>
							<li class="page-scroll">
								<a href="#services"><span data-hover="Services">우리의 전문분야</span></a>
							</li>
							<li class="page-scroll">
								<a href="#why-we"><span data-hover="Why we">저희와 함께라면...</span></a>
							</li>
							<li class="page-scroll">
								<a href="#benefits"><span data-hover="Benefits">제이비엘만의 자랑</span></a>
							</li>
							<li class="page-scroll">
								<a href="#our-cases"><span data-hover="Our cases">사례보고</span></a>
							</li>
							<li class="page-scroll">
								<a href="#team"><span data-hover="Team">변호사 약력</span></a>
							</li>
							<li class="page-scroll">
								<a href="#testimonials"><span data-hover="Testimonials">후기</span></a>
							</li>
							<li class="page-scroll">
								<a href="#blog"><span data-hover="Blog">관련기사</span></a>
							</li>
							<li class="page-scroll">
								<a href="#contact"><span data-hover="Contact">찾아오시는 길</span></a>
							</li>
						</ul>
					</div>
				</div>
		...
		<div class="promo g-theme-bg-color-1">
			<div class="rev_slider_wrapper fullwidthbanner-container" data-alias="image-hero20">
				...
				<div id="rev_slider_20_1" class="rev_slider fullwidthabanner" style="display: none;" data-version="5.0.7">
					<ul>
						<!-- SLIDE  -->
						<li data-index="rs-68" data-transition="zoomout" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="./resources/assets/img-temp/promo/img1.jpg" data-rotate="0" data-saveperformance="off" data-title="Intro" data-description="">

							<!-- MAIN IMAGE -->
							<img src="./resources/assets/img-temp/promo/img1.jpg" alt="" data-bgposition="50% 10%" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
							...
							<div class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0"
								...
								style="z-index: 7; white-space: nowrap; text-align: center; text-transform: uppercase;">제이비엘<br> 법률사무소
							</div>
							...
							<div class="tp-caption NotGeneric-SubTitle tp-resizeme rs-parallaxlevel-0"
								...
								style="z-index: 8; white-space: nowrap; text-align: center; text-transform: uppercase;">Donec erat urna, tincidunt at leo non, blandit finibus ante.<br> Nunc venenatis risus in finibus dapibus. Ut ac massa sodales,<br> mattis enim id, efficitur tortor. Nullam
							</div>
		...
		<section id="why-we" class="g-theme-bg-color-1 g-text-color-2 no-column-space">
			<div class="container-fluid">
				<div class="row equal-height-columns">
					...
					<div class="col-sm-6">
						<img class="equal-height-column" src="./resources/assets/img-temp/PeopleImages.com-ID64840.jpg" alt="" height="500">
					</div>
				</div>
			</div>
		</section>
		...
		<section id="benefits" class="g-theme-bg-color-1 g-text-color-2 no-column-space">
			<div class="container-fluid">
				<div class="row equal-height-columns">
					<div class="col-sm-6">
						<img class="equal-height-column hidden-xs" src="./resources/assets/img-temp/PeopleImages.com-ID376522.jpg" alt="" height="500">
					</div>
					...
					<div class="col-sm-12">
						<ul class="owl-lawyer list-unstyled g-text-color-2 equal-height-columns">
							<li class="item">
								<div class="col-sm-6">
									<div class="caption-outer">
										<img class="img-responsive" src="./resources/assets/img-temp/cases/PeopleImages.com-ID46357.jpg" alt="">
								...
								<div class="col-sm-6">
									<div class="caption-outer">
										<img class="img-responsive" src="./resources/assets/img-temp/cases/PeopleImages.com-ID1265766.jpg" alt="">
										<div class="caption g-theme-bg-color-transparent-1 g-va-middle g-padding-25">
											<div class="valign__middle">
							...
							<li class="item">
								<div class="col-sm-6">
									<div class="caption-outer">
										<img class="img-responsive" src="./resources/assets/img-temp/cases/PeopleImages.com-ID32142.jpg" alt="">
										<div class="caption g-theme-bg-color-transparent-1 g-va-middle g-padding-25">
											<div class="valign__middle">
												<h5 class="text-uppercase"><strong>Fusce Dictum Orci Libero</strong></h5>
												<p>Quisque rhoncus euismod pulvinar. Nulla non arcu at lectus.</p>
								...
								<div class="col-sm-6">
									<div class="caption-outer">
										<img class="img-responsive" src="./resources/assets/img-temp/cases/PeopleImages.com-ID375436.jpg" alt="">
										<div class="caption g-theme-bg-color-transparent-1 g-va-middle g-padding-25">
											<div class="valign__middle">
												<h5 class="text-uppercase"><strong>Integer Commodo</strong></h5>
												<p>Quisque rhoncus euismod pulvinar. Nulla non arcu at lectus.</p>
							...
							<li class="item">
								<div class="col-sm-6">
									<div class="caption-outer">
										<img class="img-responsive" src="./resources/assets/img-temp/cases/flickr.com___photos___highwaysagency___5998133376___sizes___o.jpg" alt="">
										<div class="caption g-theme-bg-color-transparent-1 g-va-middle g-padding-25">
											<div class="valign__middle">
												<h5 class="text-uppercase"><strong>Fusce Dictum Orci Libero</strong></h5>
												<p>Quisque rhoncus euismod pulvinar. Nulla non arcu at lectus.</p>
								...
								<div class="col-sm-6">
									<div class="caption-outer">
										<img class="img-responsive" src="./resources/assets/img-temp/cases/PeopleImages.com-ID48289.jpg" alt="">
										<div class="caption g-theme-bg-color-transparent-1 g-va-middle g-padding-25">
											<div class="valign__middle">
												<h5 class="text-uppercase"><strong>Integer Commodo</strong></h5>
												<p>Quisque rhoncus euismod pulvinar. Nulla non arcu at lectus.</p>
			...
			<div class="container g-pt-100 g-pb-40">
				<div class="row">
					...
					<div class="col-md-3 col-xs-4 col-3xs-12">
						<div class="team-v-8">
							<img class="img-responsive" src="./resources/assets/img-temp/team/team1.jpg" alt="">
					...
					<div class="col-md-3 col-xs-4 col-3xs-12">
						<div class="team-v-8">
							<img class="img-responsive" src="./resources/assets/img-temp/team/team3.jpg" alt="">
							<p class="post text-uppercase g-theme-text-color-1 g-mb-15"><strong>Partner</strong></p>
					...
					<div class="col-md-3 col-xs-4 col-3xs-12">
						<div class="team-v-8">
							<img class="img-responsive" src="./resources/assets/img-temp/team/team2.jpg" alt="">
							<p class="post text-uppercase g-theme-text-color-1 g-mb-15"><strong>Partner</strong></p>
			...
			<div class="container">
				...
				<div class="ms-staff-carousel">
					...
					<div class="master-slider" id="masterslider">
						<!-- Item 1 -->
						<div class="ms-slide">
							<img src="./resources/assets/plugins/master-slider/masterslider/style/blank.gif" data-src="./resources/assets/img-temp/testimonials/t1.jpg" alt="">
							<div class="ms-info">
						...
						<!-- Item 2 -->
						<div class="ms-slide">
							<img src="./resources/assets/plugins/master-slider/masterslider/style/blank.gif" data-src="./resources/assets/img-temp/testimonials/t2.jpg" alt="">
							<div class="ms-info">
						...
						<!-- Item 3 -->
						<div class="ms-slide">
							<img src="./resources/assets/plugins/master-slider/masterslider/style/blank.gif" data-src="./resources/assets/img-temp/testimonials/t3.jpg" alt="">
							<div class="ms-info">
						...
						<!-- Item 4 -->
						<div class="ms-slide">
							<img src="./resources/assets/plugins/master-slider/masterslider/style/blank.gif" data-src="./resources/assets/img-temp/testimonials/t4.jpg" alt="">
							<div class="ms-info">
						...
						<!-- Item 5 -->
						<div class="ms-slide">
							<img src="./resources/assets/plugins/master-slider/masterslider/style/blank.gif" data-src="./resources/assets/img-temp/testimonials/t5.jpg" alt="">
							<div class="ms-info">
				...
				<div class="row">
						<ul class="sponsors list-unstyled equal-height-columns g-dp-table g-va-middle">
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/1.png" alt="1"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/2.png" alt="2"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/3.png" alt="3"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/4.png" alt="4"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/5.png" alt="5"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/6.png" alt="6"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/7.png" alt="7"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/8.png" alt="8"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/9.png" alt="9"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/10.png" alt="10"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/11.png" alt="11"></a></div></li>
							<li class="equal-height-column g-dp-table g-va-middle"><div class="g-dp-table-cell g-va-middle"><a href="#"><img class="img-responsive" src="./resources/assets/img-temp/clients/12.png" alt="12"></a></div></li>
						</ul>
		...
		<section id="blog">
			<div class="container g-pt-100 g-pb-30">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2">
						<div class="g-heading-v9 text-center g-mb-30">
							<h2 class="text-uppercase"><strong>Latest Posts</strong></h2>
						</div>
						<p class="g-fs-16 text-center g-mb-70">Sed feugiat porttitor nunc, non dignissim ipsum vestibulum in. Donec in blandit dolor. Vivamus a fringilla lorem, vel faucibus ante. Nunc ullamcorper, justo a iaculis elementum, enim orci viverra eros, fringilla porttitor lorem eros vel</p>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-4 col-3xs-12 lawyer-post g-mb-50">
						<img class="img-responsive full-width g-mb-25" src="./resources/assets/img-temp/blog/flickr.com__photos__ter-burg__9216004446__sizes__k.jpg" alt="">
						<p class="g-fs-10 g-theme-text-color-1"><strong>April 27, 2015</strong></p>
						<h5 class="text-uppercase"><strong>Mauris tellus magna, pretium</strong></h5>
					...
					<div class="col-xs-4 col-3xs-12 lawyer-post g-mb-50">
						<img class="img-responsive full-width g-mb-25" src="./resources/assets/img-temp/blog/isorepublic.com___helical-walkway.jpg" alt="">
						<p class="g-fs-10 g-theme-text-color-1"><strong>April 27, 2015</strong></p>
					...
					<div class="col-xs-4 col-3xs-12 lawyer-post g-mb-50">
						<img class="img-responsive full-width g-mb-25" src="./resources/assets/img-temp/blog/tkLOe7nnQ7mnMsiuijBy_hm.jpg" alt="">
						<p class="g-fs-10 g-theme-text-color-1"><strong>April 27, 2015</strong></p>
						<h5 class="text-uppercase"><strong>Proin egestas purus eget pulvinar</strong></h5>
						<p class="g-fs-10 text-uppercase">by Dorian Gray for law</p>
						<p>Fusce vel aliquet arcu. Aenean malesuada a sem sed facilisis. Maecenas aliquam faucibus metus, nec auctor est.</p>
	...
	<script src="https://maps.googleapis.com/maps/api/js?signed_in=true&amp;callback=initMap" async defer></script><script src="./resources/assets/js/plugins/gmaps-ini.js"></script>
